#ifndef LAFUNCS_FINAL_STEP__H
#define LAFUNCS_FINAL_STEP__H
...
// matrix is positive,
// row_i of eigenVecsRowWise and component i of eigenValues are eigenvector and eigenvalue #i
// since the matrix is positive, eigenvectors are orthonormal
...
// Dim > 1	-> vec_t = [v1, v2], vec_t_abs = norm2(v1, v2), vec_effective = sqrt(vec_n_pos^2 + (beta * vec_t_abs)^2)
class Vec_nt
{
public:
	Vec_nt();
...
template<class T>
void ReadVector(istream& in, vector<T>& dat) 
{
	T tmp;
	string buf;
